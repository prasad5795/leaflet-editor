...
export class Deletion extends React.Component {
  ...
  componentDidMount () {
    document.title = 'Tori Deletion Check'
    this.props.getDeletionTask()
    this.renderPopup()
  ...
  handleCompletedTask(choice, userComment = '') {
    ...
    case 'y':
      ...
      this.props.postCompletedDeletionTask(task)
      break
    case 'n':
...
export default connect(mapStateToProps, { getDeletionTask, addAcceptedFeature, addRejectedFeature, postCompletedDeletionTask })(ToriMap(Deletion, { zoomLevel }))
